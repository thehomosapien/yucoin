...
/** Utility functions used by the YUCcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render YUC addresses in monospace font
...
// Parse "yucoin:" URI into recipient object, return true on successful parsing
