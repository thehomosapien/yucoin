...
#   c) node1 mines 32 blocks, so now node 0 has 500000YUC, node 1 has 4250YUC, node2 has none.
#   d) node0 sends 601 YUC to node2, in two transactions (301 YUC, then 300 YUC).
