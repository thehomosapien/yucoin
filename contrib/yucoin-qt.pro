...
RESOURCES += src/qt/yucoin.qrc src/qt/yucoin_locale.qrc

TRANSLATIONS += src/qt/locale/yucoin_bg.ts \
                src/qt/locale/yucoin_de.ts \
                src/qt/locale/yucoin_en.ts \
                src/qt/locale/yucoin_es.ts \
                src/qt/locale/yucoin_fi.ts \
                src/qt/locale/yucoin_fr.ts \
                src/qt/locale/yucoin_it.ts \
                src/qt/locale/yucoin_ja.ts \
                src/qt/locale/yucoin_pl.ts \
                src/qt/locale/yucoin_pt.ts \
                src/qt/locale/yucoin_ru.ts \
                src/qt/locale/yucoin_sk.ts \
                src/qt/locale/yucoin_sv.ts \
                src/qt/locale/yucoin_vi.ts \
                src/qt/locale/yucoin_zh_CN.ts \
                src/qt/locale/yucoin_zh_TW.ts
