...
This mechanism has been integrated into Bitcore-Node-YUCcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/yucoin/insight-api-yucoin#web-socket-api](https://github.com/yucoin/insight-api-yucoin#web-socket-api)
* API: [https://github.com/yucoin/insight-api-yucoin#swifttx-transactions](https://github.com/yucoin/insight-api-yucoin#swifttx-transactions)
...
By default, the YUCOIN daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the YUCOIN daemon:
