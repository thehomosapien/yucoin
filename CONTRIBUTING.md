Contributing to YUCOIN
==================================

The YUCOIN project operates an open contributor model where anyone is
...
The following applies to code changes to the YUCOIN project, and is not to be
confused with overall YUCOIN Network Protocol consensus changes.

Whether a pull request is merged into YUCOIN rests with the project merge
...
The project leader is the release manager for each YUCOIN release.
