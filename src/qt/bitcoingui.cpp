                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("YUC Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a YUC address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About YUCOIN"), this);
    aboutAction->setStatusTip(tr("Show information about YUCOIN"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for YUCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your YUC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified YUC addresses"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the YUCOIN help message to get a list with possible YUCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("YUCOIN client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to YUCOIN network", "", count));
}
