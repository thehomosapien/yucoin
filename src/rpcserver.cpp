...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* YUCOIN features */
        {"YUCOIN", "masternode", &masternode, true, true, false},
        {"YUCOIN", "listmasternodes", &listmasternodes, true, true, false},
        {"YUCOIN", "getmasternodecount", &getmasternodecount, true, true, false},
        {"YUCOIN", "masternodeconnect", &masternodeconnect, true, true, false},
        {"YUCOIN", "masternodecurrent", &masternodecurrent, true, true, false},
        {"YUCOIN", "masternodedebug", &masternodedebug, true, true, false},
        {"YUCOIN", "startmasternode", &startmasternode, true, true, false},
        {"YUCOIN", "createmasternodekey", &createmasternodekey, true, true, false},
        {"YUCOIN", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"YUCOIN", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"YUCOIN", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"YUCOIN", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"YUCOIN", "getmasternodescores", &getmasternodescores, true, true, false},
        {"YUCOIN", "mnbudget", &mnbudget, true, true, false},
        {"YUCOIN", "preparebudget", &preparebudget, true, true, false},
        {"YUCOIN", "submitbudget", &submitbudget, true, true, false},
        {"YUCOIN", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"YUCOIN", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"YUCOIN", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"YUCOIN", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"YUCOIN", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"YUCOIN", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"YUCOIN", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"YUCOIN", "checkbudgets", &checkbudgets, true, true, false},
        {"YUCOIN", "mnsync", &mnsync, true, true, false},
        {"YUCOIN", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
