...
In order to support loading of multiple wallets in yucoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is yucoin.cpp.
...
Changes to yucoin.cpp
----------------------
yucoin.cpp is the entry point into yucoin-qt, and as such, will require some minor modifications to provide hooks for
