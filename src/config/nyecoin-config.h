/* src/config/yucoin-config.h.  Generated from yucoin-config.h.in by configure.  */
/* src/config/yucoin-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_NAME "YUCOIN"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "YUCOIN 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "yucoin"
